...
The input dimension is equal to the window size ($m$, Eq. \ref{eq:wd}), and the output dimension corresponds to the prediction horizon (). The hidden layer contains 128 nodes. In practice, the properties of the Bayesian neural networks are saved with standard fixed-point neural networks and sampled parameters.
